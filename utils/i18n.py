...
TRANSLATIONS: Dict[str, Dict[str, Union[str, List[str]]]] = {
    'es': {
        ...
        'pole.after_opening.1': 'Mañana',
        'pole.after_opening.2': 'mañana bro',
        'pole.after_opening.3': 'Mañana será',
        'pole.after_opening.4': 'F en el chat. Mañana',
        ...
        'putometro.trigger.title.boss': '🔥 BOSS MODE EN LLAMAS 🔥',
        'putometro.trigger.desc.boss': '🔥 {mention} encadenó **{window_count}** en **{window_seconds}s** (mensaje actual: **{message_count}**). El chat está ardiendo. 🔥',
        'putometro.spam.warning.title': '⚠️ Aviso Anti-Spam',
        'putometro.spam.warning.desc': '⚠️ Aviso Anti-Spam [{current}/{limit}]: Detectado intento de farmeo masivo. Deja de espamear o habrá consecuencias severas.',
        'putometro.spam.penalty.title': '❌ PENALIZACIÓN APLICADA',
        'putometro.spam.penalty.desc': '❌ PENALIZACIÓN APLICADA. Has ignorado los avisos. El putómetro te ha restado 🔥 {penalty} puntos 🔥 por spammer.',
    ...
    'en': {
        ...
        'pole.after_opening.1': 'Tomorrow',
        'pole.after_opening.2': 'tomorrow bro',
        'pole.after_opening.3': 'Tomorrow it is',
        'pole.after_opening.4': 'F in chat. Tomorrow.',
        ...
        'putometro.trigger.title.boss': '🔥 BOSS MODE ON FIRE 🔥',
        'putometro.trigger.desc.boss': '🔥 {mention} chained **{window_count}** within **{window_seconds}s** (current message: **{message_count}**). The chat is burning. 🔥',
        'putometro.spam.warning.title': '⚠️ Anti-Spam Warning',
        'putometro.spam.warning.desc': '⚠️ Anti-Spam Warning [{current}/{limit}]: Massive farming attempt detected. Stop spamming or severe consequences will follow.',
        'putometro.spam.penalty.title': '❌ PENALTY APPLIED',
        'putometro.spam.penalty.desc': '❌ PENALTY APPLIED. You ignored the warnings. The putometer deducted 🔥 {penalty} points 🔥 for spamming.',
